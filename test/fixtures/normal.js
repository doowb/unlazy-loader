...
utils.paginationator = require('paginationator');
utils.sortBy = require('array-sort');
utils.groupBy = require('group-array');
...
// routing
utils.router = require('en-route');

// engines, templates and helpers
utils.loader = require('load-helpers');
utils.engine = require('engine-base');
utils.Engines = require('engine-cache');
utils.Helpers = require('helper-cache');
utils.rethrow = require('template-error');
utils.inflect = require('inflection');
utils.layouts = require('layouts');

// glob/matching utils
utils.globby = require('globby');
utils.mm = require('micromatch');
utils.isValidGlob = require('is-valid-glob');
utils.hasGlob = require('has-glob');
